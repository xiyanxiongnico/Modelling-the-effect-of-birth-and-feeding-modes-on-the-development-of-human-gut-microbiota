...
output_dynamics_csection <- "data/dynamics_LinearCombinationMmodel_c-section.rData"
output_dynamics_vaginal <- "data/dynamics_LinearCombinationMmodel_vaginal.rData"
...
# vaginal birth
y0_vaginal <- c(B_1 = 50/k,B_2 = 50/k,B_3 = 1/k,M = 1/k) 

# C-section
y0_csection <- c(B_1 = 1/k,B_2 = 1/k,B_3 = 50/k,M = 1/k) 
...
names(bacteria_vaginal)[5] <- "Immune factor M"
...
names(bacteria_csection)[5] <- "Immune factor M"
...
bacteria_melt_vaginal <- melt(data = bacteria_vaginal, id.vars = "time", 
                              measure.vars = c("HMO-consuming Bifidobacteria B1", "Fibre-consuming Bifidobacteria B2",
                                               "Commensal competitor B3","Immune factor M"))
